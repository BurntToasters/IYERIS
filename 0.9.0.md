<p align="center">
  <img width="45%" height="1012" alt="IYERIS-9-1" src="https://github.com/user-attachments/assets/PLACEHOLDER1" />
&nbsp;
<img width="45%" height="1012" alt="IYERIS-9-2" src="https://github.com/user-attachments/assets/PLACEHOLDER2" />
&nbsp;
<img width="45%" height="1012" alt="IYERIS-9-3" src="https://github.com/user-attachments/assets/PLACEHOLDER3" />
</p>

> [!NOTE]
> This is a **beta release** (`v0.9.0-beta.1`). Please report any issues you encounter!
...
| :--- | :--- | :--- |
| **[Universal EXE (x64/arm64)](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-Win.exe)** | **[Universal DMG](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-MacOS-universal.dmg)** | **AppImage:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-Linux-x86_64.AppImage) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-Linux-arm64.AppImage) |
| <div align="center"><a href="https://apps.microsoft.com/detail/9pkgd6lkcl5j?referrer=appbadge&mode=full"><img src="https://get.microsoft.com/images/en-us%20light.svg" width="150"/></a></div> | **[Universal ZIP](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-MacOS-universal.zip)** | **DEB:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-Linux-amd64.deb) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-Linux-arm64.deb) |
| *See MSI note below* | | **RPM:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-Linux-x86_64.rpm) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/IYERIS-Linux-aarch64.rpm) |
| | | **Flatpak:** [Flatpak Bundle](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.1/iyeris.flatpak) |
...
| **Windows - MSI (ARM64/x64)** | ✅ Signed (GPG) | Auto-updates disabled on MSI versions. This is meant for enterprise deployments ONLY. |
| **[Microsoft Store](https://apps.microsoft.com/detail/9pkgd6lkcl5j)** | ➖ Pending... | `v0.9.0-beta.1` is pending approval from Microsoft... |
...
### Recent Files
A new "Recent" section has been added to the sidebar! IYERIS now tracks recently opened files, making it easy to quickly access files you've been working with. The list is automatically updated as you open files and persists across sessions.

### Folder Statistics
The Properties modal now shows a breakdown of file types within a folder! When viewing folder properties, you'll see:
* File type distribution with counts and sizes
* Visual progress bars showing relative sizes
* Top 10 file types sorted by size

### List View Thumbnails
Image thumbnails now display in List View mode with improved styling, including rounded corners and subtle shadows for a more polished look.

### Custom Theme Editor Improvements
* Fixed an issue where users couldn't re-open the theme editor after selecting a custom theme (no longer need to switch themes first)
* The "Custom..." option now always displays as "Custom..." instead of changing to the theme name
...
* **MS STORE:** IYERIS doesn't open on login despite users turning on the setting to do so. [#26]
  * *Partially addressed in this release - testing ongoing*
