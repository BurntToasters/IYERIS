...
> [!NOTE]
> This is a 🅱️ **beta release** (`v0.9.0-beta.7`). Please report any issues you encounter!
>
...
| :--- | :--- | :--- |
| **[Universal EXE (x64/arm64)](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-Win.exe)** | **[Universal DMG](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-MacOS-universal.dmg)** | **AppImage:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-Linux-x86_64.AppImage) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-Linux-arm64.AppImage) |
| <div align="center"><a href="https://apps.microsoft.com/detail/9pkgd6lkcl5j?referrer=appbadge&mode=full"><img src="https://get.microsoft.com/images/en-us%20light.svg" width="150"/></a></div> | **[Universal ZIP](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-MacOS-universal.zip)** | **DEB:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-Linux-amd64.deb) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-Linux-arm64.deb) |
| *See MSI note below* | | **RPM:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-Linux-x86_64.rpm) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-Linux-aarch64.rpm) |
| | | **Flatpak:** [Flatpak Bundle](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.7/IYERIS-Linux-beta.flatpak) |
...
## What's New in `v0.9.0-beta.7` **(RC)**
...
* **Empty Text Files:** Fixed an issue where empty text files could cause the file preview handler to crash.
* **File Preview:** Fixed an issue it the new async file previewer code that could cause the file previewer to not update if a user selects another file quickly.
* **Open in Terminal:** Fixed an issue on Windows and MacOS where the `Open in Terminal` context menu option would associate its launch with IYERIS, preventing IYERIS from shutting down whilst that terminal window was open.
* **Disk Size:** Fixed an issue where if a users' computers had low disk space availabe, the Disk Size GUI wouldn't properly render.
...
* **Git Integration** - Visual badges on files show their git status at a glance
