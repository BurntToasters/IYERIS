...
> [!NOTE]
> This is a 🅱️ **beta release** (`v0.9.0-beta.6`). Please report any issues you encounter!
>
...
| :--- | :--- | :--- |
| **[Universal EXE (x64/arm64)](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-Win.exe)** | **[Universal DMG](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-MacOS-universal.dmg)** | **AppImage:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-Linux-x86_64.AppImage) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-Linux-arm64.AppImage) |
| <div align="center"><a href="https://apps.microsoft.com/detail/9pkgd6lkcl5j?referrer=appbadge&mode=full"><img src="https://get.microsoft.com/images/en-us%20light.svg" width="150"/></a></div> | **[Universal ZIP](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-MacOS-universal.zip)** | **DEB:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-Linux-amd64.deb) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-Linux-arm64.deb) |
| *See MSI note below* | | **RPM:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-Linux-x86_64.rpm) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-Linux-aarch64.rpm) |
| | | **Flatpak:** [Flatpak Bundle](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.6/IYERIS-Linux-beta.flatpak) |
...
## What's New in `v0.9.0-beta.6`
* **GIT Status:** GIT status is now OPT-IN (disabled by default as it can result in longer directory loads).
* **Syntax Highlighting:** Syntax code highlighting now uses the npm highlight.js package instead of a cloud-based one! Now enabled by default.
* **Directory Browsing:** Fixed an issue where switching between directories may have a ~500MS delay.
* **MT:** More multi-threaded/worker additions.
