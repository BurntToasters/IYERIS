...
> [!NOTE]
> This is a 🅱️ **beta release** (`v0.9.0-beta.4`). Please report any issues you encounter!
>
...
| :--- | :--- | :--- |
| **[Universal EXE (x64/arm64)](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-Win.exe)** | **[Universal DMG](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-MacOS-universal.dmg)** | **AppImage:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-Linux-x86_64.AppImage) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-Linux-arm64.AppImage) |
| <div align="center"><a href="https://apps.microsoft.com/detail/9pkgd6lkcl5j?referrer=appbadge&mode=full"><img src="https://get.microsoft.com/images/en-us%20light.svg" width="150"/></a></div> | **[Universal ZIP](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-MacOS-universal.zip)** | **DEB:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-Linux-amd64.deb) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-Linux-arm64.deb) |
| *See MSI note below* | | **RPM:** [x64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-Linux-x86_64.rpm) / [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-Linux-aarch64.rpm) |
| | | **Flatpak:** [Flatpak Bundle](https://github.com/BurntToasters/IYERIS/releases/download/v0.9.0-beta.4/IYERIS-Linux-beta.flatpak) |
...
### TABS!
Yes, tab browsing is finaly in IYERIS! Welcome to tab browsing, 
* Browse multiple directories all in the same IYERIS window!
* Speed up your workflow!
* Keep your current progress on one tab whilst working on another item in a different tab!

### Codebase
* **TS:** Moved default settings to a new TS file: settings.ts
* **Security:** Implimented Security testing in IYERIS, done by security.ts/security.tests.ts: `npm test`
* **Codebase:** Large amounts of code have been moved around or optimized to futher improve performance for Linux/MacOS
* **File Naming:** IYERIS now properly supports Linux/MacOS file character names.
